...
<section class="how-to-brazilian-jiu-jitsu">
    <div class="content-wrapper hero-content">
        ...
        <div class="section-body " >
            ...
            <a href="{{ route('first') }}" class="submit-btn">初めての方へ</a>
        </div>
    </div>
</section>
        ...
        <div class="flex-center-top mita-columns">
            ...
            <div class="mita-column">
                ...
                <div class="mita-content">
                    ...
                    <p>初心者の方でも女性の方でも安心、安全に通えるのが、ARTA BJJ Mitaです。在籍されているほとんどの方が、格闘技経験はなく、ゼロからスタートしている方ばかりです。初心者の方の為にも「白帯限定クラス」「ベーシッククラス」があり、「女性限定クラス」では女性インストラクターが指導します。どのクラスもスパーリングを強制することはありません。それぞれのペースで柔術を楽しみましょう！</p>
                </div>
            </div>
            ...
            <div class="mita-column">
                ...
                <div class="mita-content">
                    ...
                    <p>格闘技ジムは「汚い」「怖い」というイメージがあるかもしれませんが、ARTA BJJ Mitaは清潔なマット、ラウンジ、ロッカールームを完備しています。また、メンバーの皆さんは明るく、クラス中も笑顔が絶えません。安心して通える環境を整えています。</p>
                </div>
            </div>
            ...
            <div class="mita-column">
                ...
                <div class="mita-content">
                    ...
                    <p>ARTA BJJ Mitaのスタッフは、現役の柔術家です。2021年JBJJF全日本選手権無差別級優勝者も在籍しています。私たちのモットーは「完璧より前進」です。完璧な日はなかなかありませんが、日々少しずつ前進していくことが大切です。柔術を始めたいと思っている方は、ぜひこの考え方で一緒に成長していきましょう。</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="access-content">
            <div class="access-info">
                <div class="access-item">
                    ...
                    <p class="access-value">ARTA BJJ Mita</p>
                </div>
                <div class="access-item">
